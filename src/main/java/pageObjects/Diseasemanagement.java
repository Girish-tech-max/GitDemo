...
public class Diseasemanagement {
	...
	private By diseasemanagement = By.cssSelector("[href='/admin/crops/criteria/diseases']");

	private By hamburgericon = By.cssSelector("a.sidebar-toggler.not-active");

	private By getdisease = By.cssSelector("button#upmargin.btn.btn-success");

	private By homelink = By.xpath("//a[contains(text(),'Home')]");

	public Diseasemanagement(WebDriver driver) {
	...
	public WebElement getdiseasemanagement() {
		return driver.findElement(diseasemanagement);
	}
	...
	public WebElement getdisease() {
		return driver.findElement(getdisease);
	}
