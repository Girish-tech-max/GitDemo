...
public class Additionalactivities {
	...
	private By additionalactivities= By.cssSelector("[href='/admin/crops/additional/addActivities']");
	...
	public Additionalactivities(WebDriver driver) {
	...
	public WebElement getadditionalactivities() {
		return driver.findElement(additionalactivities);
	}
