...
import pageObjects.Additionalactivities;
import pageObjects.SignIn;
import resources.base;

public class Additionalactivitiespage extends base {
	...
	public void additionalpactivities() throws InterruptedException {
		...
		lp.getsignin().click();
		Additionalactivities add = new Additionalactivities(driver);
		Thread.sleep(5000);
		add.getcropmastermanagement().click();
		Thread.sleep(5000);
		log.info("clicked on crop master management");
		add.getadditionalactivities().click();
		Thread.sleep(5000);
		log.info("clicked on Additional Activities");
		add.gethamburgericon().click();
		Thread.sleep(5000);
		log.info("clicked on hamburger icon");
		add.getactivitiesbutton().click();
		Thread.sleep(5000);
